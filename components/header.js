      ...
      >
        ...
        <div data-role="MobileMenu" className="header-mobile-menu" style={{ display: isMobileMenuOpen ? 'block' : 'none' }} onClick={onToggleMobileMenu}>
          <nav className="header-nav1">
            ...
            <NavigationLinks6 rootClassName="rootClassName14"></NavigationLinks6>
          </nav>
          <div>
      ...
      <style jsx>
        {`
          ...
          .header-mobile-menu {
            ...
            justify-content: space-between;
            background-color: var(--dl-color-act60directory-brand);
          }
          .header-nav1 {
            display: flex;
...
Header.defaultProps = {
  Image_alt: 'logo',
  Image_src: 'https://i.imgur.com/Y7uJArP.png',
  rootClassName: '',
  image_alt: 'image',
  button: 'Contact Us',
  image_src: 'https://i.imgur.com/Y7uJArP.png',
